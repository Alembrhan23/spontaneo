...
// // Find the next First Friday in October
// function getNextOctoberFirstFriday() {
//   const now = new Date()
//   let year = now.getFullYear()
//   let october = new Date(year, 9, 1) // October 1
//   while (october.getDay() !== 5) { october.setDate(october.getDate() + 1) }
//   if (october < now) {
//     year++
//     october = new Date(year, 9, 1)
//     while (october.getDay() !== 5) { october.setDate(october.getDate() + 1) }
//   }
//   return october
// }
...
// /* ---------- page ---------- */
// export default function FirstFridayClient() {
...
//   const params=useSearchParams(); const router=useRouter(); const selectedId=params.get('occ') || null
...
//   // Adjusted previous logic: if current occ is past, include it in previous list
//   const previous = useMemo(()=>{
//     if (!occ) return []
//     const occDate = localDateFromISO(occ.event_date)
//     const isPast = occDate < new Date()
//     const base = allOccs.filter(o=>o.id!==occ.id)
//     return isPast ? [occ, ...base].reverse() : base.reverse()
//   },[allOccs,occ])
...
//   const nextOctoberFF = useMemo(() => getNextOctoberFirstFriday(), [])
...
//                 {nextOctoberFF && (
//                   <Badge className="bg-purple-100 text-purple-800 border border-purple-200 dark:bg-purple-900/40 dark:text-purple-200 dark:border-purple-700/40">
//                     Next October FF in {formatDuration(nextOctoberFF.getTime() - Date.now())}
//                   </Badge>
//                 )}
//               </div>
...
//                 <Badge className="bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-900/40 dark:text-emerald-200 dark:border-emerald-400/20">{stats.venues} Venues</Badge>
